...
flags.DEFINE_string('DEFAULT_IN', '/Volumes/GoogleDrive/My Drive/2019/MCEN90048 AI for Mechatronics/ai_for_mechatronics/Datasets/', 'Default input folder.')
flags.DEFINE_string('DEFAULT_OUT', '/Volumes/GoogleDrive/My Drive/2019/MCEN90048 AI for Mechatronics/ai_for_mechatronics/Results/', 'Default output folder.')
flags.DEFINE_string(
    'DEFAULT_DOWNLOAD', '/Volumes/GoogleDrive/My Drive/2019/MCEN90048 AI for Mechatronics/ai_for_mechatronics/Datasets/',
